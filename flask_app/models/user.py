...
class User:
    ...
    def validate_register(user):
        ...
        if len(user["username"].strip()) == 0:
            ...
            is_valid = False
        elif len(user["username"].strip()) > 20:
            flash("Username must be less than 20 characters.", "register")
            is_valid = False
    ...
    def register(cls, data):
        ...
        created_at, updated_at) VALUES ( %(username)s, %(first_name)s, %(last_name)s, %(email)s, 
        %(password)s, NOW(), NOW());"""
